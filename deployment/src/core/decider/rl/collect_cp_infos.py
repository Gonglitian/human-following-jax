...
def collect_cp_infos(actor_critic, eval_envs, num_processes, device, test_size, config, args, model_file_name, required_samples, gif_save_path):
    ...
    for k in range(test_size):
        ...
        csv_file_path = f"{config.unsafe_samples_path}/{model_file_name[:-3]}.csv"
