...
class PPOLag():
    ...
    def __init__(self,
        ...
        self.cost_actor_critic = cost_actor_critic # yjp mark: actually we only use & update critic part
        ...
        lagrange_cfgs = {
            'cost_limit': cost_limit, # original value 25 
            # yjp mark: cost_limit can be passed in (equal to agent.get_aggr_value())
            # belove 20 means that in average it is not collide everytime
    ...
    def update(self, rollouts, mean_ep_costs):
        ...
        for e in range(self.ppo_epoch): # yjp mark: several iterations of policy
            ...
            for sample in data_generator:
                ...
                # tag
                # yjp mark: modify advantage (adv_targ)
