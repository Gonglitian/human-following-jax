...
class Monitor(Wrapper):
    ...
    def update_monitor(self, data):
        ob, rew, done, info = data
        return self.update(ob, rew[0], done, info)
    ...
    def update(self, ob, rew, done, info):
        ...
        if done:
            ...
            if isinstance(info, dict):
                info['episode'] = epinfo # yjp mark: 在一个 episode 结束的时候 info 中会添加一个 'episode' 项
                
            self.reset_state() # yjp mark
    ...
    def get_episode_rewards(self): # unused
